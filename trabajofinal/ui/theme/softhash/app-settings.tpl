    ...
    <div class="col-md-6">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <img class="logo" src="{$app_url}sysfrm/uploads/system/logoGoodPay.png" alt="Logo">
                <br><br>
                <form role="form" name="logo" enctype="multipart/form-data" method="post" action="{$_url}settings/logo-post">
                    <div class="form-group">
                        ...
                        <p class="help-block">{$_L['This will replace existing logo']} - sysfrm/uploads/system/logoGoodPay.png</p>
                    </div>
                    <button type="submit" class="btn btn-primary"><i class="fa fa-check"></i> {$_L['Submit']}</button>
                </form>
